...
- **rules-to-checks** — a repeated agent mistake becomes a script, hook or test, not another CLAUDE.md line.
...
- **feedback-loop-ceiling** — An AI agent's output quality is hard-capped by the quality of the signals it receives — slow tests, vague type errors, flaky assertions, and.
